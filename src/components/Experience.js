        ...
        return(
            ...
            <Fade bottom>
                <div className="about w-70-ns m-auto">
                    <h1 className='tc pl4'>Experience</h1>
                    <div className='flex-l '>
                        <ul className='flex justify-around pa0 w-20-l flex-wrap-l flex-column-l br-l '>
                            <li className='pa2 ph2 link pointer hover-moon-gray' ><a className={this.state.active === 'work1' ? 'active' : ''} onClick={() => this.handleClick('Work1','work1')}>Web Developer</a></li>
                            <li className='pa2 ph2 link pointer hover-moon-gray'><a className={this.state.active === 'work2' ? 'active' : ''} onClick={() => this.handleClick('Work2','work2')}>IT Help Desk</a></li>
